...
import { AprMap } from '@plexswap/farms'
...
const BLOCK_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/symplexialabs/plexblocks'
const INFO_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/symplexialabs/plexswap'
